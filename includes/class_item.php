...
class item extends custom_field
{
	...
	function upload_manager($variables_array, $media_type = 1, $form_name = null, $manager_display = false, $new_table = false, $box_title = true, $display_fee = null)
	{
		...
		$fee_message = isset($fee_message)?$fee_message:""; //otherwise it complains
	...
	function media_removal($variables_array, $file_type, $file_id, $remove_row = true)
	{
		...
		{
			//$variables_array[$media_name][$i] = $variables_array[$media_name][$i+1]; old
			$variables_array[$media_name][$i] = isset($variables_array[$media_name][$i+1])?$variables_array[$media_name][$i+1]:$variables_array[$media_name][$i];
		}
