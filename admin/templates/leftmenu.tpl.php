	...
	<tr>
		<td colspan="2">
			...
			<?php if (
				...
				isset($_REQUEST['page']) && $_REQUEST['page']=='register' ||
				isset($_REQUEST['page']) && $_REQUEST['page']=='reputation_sale' || 
				isset($_REQUEST['page']) && $_REQUEST['page']=='reputation_purchase' ) { } 
			else { ?>
	...
	<tr>
		<td colspan="2">
			...
			<?php if (
				...
				isset($_REQUEST['page']) && $_REQUEST['page']=='auction' ||
				isset($_REQUEST['page']) && $_REQUEST['page']=='wanted_ad' ) { } 
			else { ?>
	...
	<tr>
		<td colspan="2">
			...
			<?php if (
				...
				isset($_REQUEST['page']) && $_REQUEST['page']=='enable_stores' ) { } 
			else { ?>
	...
	<tr>
		<td colspan="2">
			...
			<?php if (
				...
				isset($_REQUEST['page']) && $_REQUEST['page']=='mcrypt' ) { } 
			else { ?>
	...
	<tr>
		<td colspan="2">
			...
			<?php if (
				...
				isset($_REQUEST['page']) && $_REQUEST['show']=='accounting_overdue' ) { } 
			else { ?>
	...
	<tr>
		<td colspan="2">
			...
			<?php if (
				...
				isset($_REQUEST['page']) && $_REQUEST['page']=='enable_tax' ) { } 
			else { ?>
